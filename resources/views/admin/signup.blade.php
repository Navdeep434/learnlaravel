                ...
                <div class="card-body ">
                    <form method="POST" action="{{ route('admin.signup.post') }}" >
                        ...
                        <div class="form-group row mb-4">
                            <label for="firstname" class="col-md-4 col-form-label text-right">{{ __('First Name') }}</label>
                        ...
                        <div class="form-group row mb-4">
                            <label for="lastname" class="col-md-4 col-form-label text-right">{{ __('Last Name') }}</label>
                        ...
                        <div class="form-group row mb-4">
                            <label for="email" class="col-md-4 col-form-label text-right">{{ __('E-Mail') }}</label>
                        ...
                        <div class="form-group row mb-4">
                            <label for="mobile" class="col-md-4 col-form-label text-right">{{ __('Mobile No.') }}</label>
                        ...
                        <div class="form-group row mb-4">
                            <label for="dob" class="col-md-4 col-form-label text-right">{{ __('Date of Birth') }}</label>
                        ...
                        <div class="form-group row mb-4">
                            <label for="gender" class="col-md-4 col-form-label text-right">{{ __('Gender') }}</label>
